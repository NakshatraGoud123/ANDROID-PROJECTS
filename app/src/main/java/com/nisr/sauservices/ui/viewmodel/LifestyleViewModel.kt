...
import com.nisr.sauservices.ui.lifestyle.LifestyleCartItem
import com.nisr.sauservices.ui.lifestyle.LifestyleServiceItem

class LifestyleViewModel : ViewModel() {
    private val _cartItems = mutableStateListOf<LifestyleCartItem>()
    val cartItems: List<LifestyleCartItem> get() = _cartItems
    ...
    fun addToCart(service: LifestyleServiceItem) {
